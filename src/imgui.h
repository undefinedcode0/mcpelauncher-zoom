...
inline void (*mcpelauncher_show_window)(const char *title, int isModal,
                                        void *user, void (*onClose)(void *user),
                                        int count, struct control *controls);
inline void (*mcpelauncher_close_window)(const char *title);
inline void (*mcpelauncher_addmenu)(size_t length,
